...
This guide assumes basic knowledge of C structures and of our database structures. It could have been a pure how-to guide (as in Diátaxis), but it made more sense to me to not split it further but rather make it an all-in-one, self-sufficient starter guide.
...
Ce guide suppose une connaissance de base des structures en C et de nos structures de base de données. Il aurait pu être un pur guide pratique (un "how-to guide" au sens de Diátaxis), mais il m'a semblé plus pertinent de ne pas le diviser davantage et d'en faire plutôt un guide de démarrage complet et autonome.
